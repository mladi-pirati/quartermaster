...
export interface RacunDocumentProps {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.infoRow}>
          ...
          <View style={styles.datesCol}>
            <View style={styles.dateRow}>
              <Text style={styles.dateLabel}>Datum izdaje računa:</Text>
              <Text style={styles.dateValue}>{format(issueDate, 'dd.MM.yyyy')}</Text>
            </View>
            <View style={styles.dateRow}>
              <Text style={styles.dateLabel}>Datum dobave:</Text>
              <Text style={styles.dateValue}>{format(deliveryDate, 'dd.MM.yyyy')}</Text>
            </View>
            <View style={styles.dateRow}>
        ...
        {/* Invoice number */}
        <Text style={styles.invoiceNumber}>Račun št.: {invoiceNumber}</Text>
        ...
        {/* Payment reference */}
        <Text style={styles.paymentLabel}>Podatki o plačilu</Text>
        ...
        {/* PLAČANO section */}
        <View style={styles.placanoSection}>
          <Text style={styles.placanoStamp}>PLAČANO</Text>
          <View style={styles.placanoDetails}>
            <Text style={styles.placanoTitle}>Plačano po predračunu</Text>
            <View style={styles.placanoRow}>
              <Text style={styles.placanoDetailLabel}>Predračun št.</Text>
              <Text style={styles.placanoDetailValue}>{invoiceNumber}</Text>
            </View>
            <View style={styles.placanoRow}>
              <Text style={styles.placanoDetailLabel}>Znesek</Text>
              <Text style={styles.placanoDetailValue}>{formatEur(grandTotal)}</Text>
            </View>
            <View style={styles.placanoRow}>
              <Text style={styles.placanoDetailLabel}>IBAN</Text>
              <Text style={styles.placanoDetailValue}>SI56 0400 1004 6962 927</Text>
            </View>
            <View style={styles.placanoRow}>
              <Text style={styles.placanoDetailLabel}>Sklic</Text>
              <Text style={styles.placanoDetailValue}>SI00 {invoiceNumber}</Text>
            </View>
          </View>
        </View>
